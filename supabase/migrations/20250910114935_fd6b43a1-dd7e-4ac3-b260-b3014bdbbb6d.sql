...
-- 🔹 Seed Data
insert into public.family (id, owner_uid, name)
values ('00000000-0000-0000-0000-000000000001', 'replace-with-auth-uid', 'Família Bessa');

insert into public.kid (family_id, display_name, age, color_hex)
values 
('00000000-0000-0000-0000-000000000001', 'Miguel', 12, '#4F46E5'),
('00000000-0000-0000-0000-000000000001', 'Theo', 9, '#059669');

insert into public.task_template (family_id, title, base_points, recurrence, icon_emoji)
values
('00000000-0000-0000-0000-000000000001', '🦷 Brush teeth', 5, 'daily', '🦷'),
('00000000-0000-0000-0000-000000000001', '📚 Study 20 minutes', 10, 'daily', '📚'),
('00000000-0000-0000-0000-000000000001', '🛏️ Make the bed', 5, 'daily', '🛏️'),
('00000000-0000-0000-0000-000000000001', '🗑️ Take out the trash', 10, 'weekly', '🗑️');

insert into public.reward (family_id, title, cost_points, icon_emoji)
values
('00000000-0000-0000-0000-000000000001', '🎮 +30 min videogame', 40, '🎮'),
('00000000-0000-0000-0000-000000000001', '🍿 Choose movie night', 60, '🍿'),
('00000000-0000-0000-0000-000000000001', '🏞️ Weekend outing', 100, '🏞️');
